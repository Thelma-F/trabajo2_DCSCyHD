...
stop_words <- stop_words %>%
 bind_rows( tibble(word=c('embed', 'leé', 'cronica.com.ar', 'minutouno.com', 'comentar', 'jpg', 'loading', 'pristupluk', '	minutouno.com', 'guardar', '	páginai12', '01', 'l.l', 'loading', 'jpe', 'más', 'también', 'está', 'había', 'qué', 'así', 'están', 'además', 'según', 'frente', 'día', '1', 'gusta', 'twitter', 'fuente', 'whatsapp', 'compartir', 'facebook', 'mail', 'él'))) %>% 
   print()
