...
metrics_rf <- collect_metrics(tune_params) ####VER! 
...
roc_auc <- filter(metrics_rf, .metric == "roc_auc")
```
...
### VER TODO ESTO que quizas no hace falta
...
```
###Pruebas Random Forest con conservador, no conservador (neutro, progresista)
...
# Recopilar métricas en un tibble
metrics_rf <- collect_metrics(tune_params2) ####VER! 
