...
Stopwords posibles de ser agregadas: 
c("a", "aún", "ante", "bajo", "con", "contra", "de", "desde", "durante","día", "días",
...
#Pasamos la primera letra de los medios en mayúscula
...
rm(top_words_by_medio, corpus_tf_idf_medio, noticias_vacias, noticias_mal_descargadas, noticias_cortas)
...
# No es seguro que sea necesario utilizar estas 3 líneas siguientes
# Dfm
# corpus_dfm <- corpus_tf_idf_noticia %>%
...
corpus_noticias <- na.omit(corpus_dtm)

topicos_4 <- LDA(corpus_dtm , 
                 k = 4, 
...
noticias_topics <- tidy(topicos_4, matrix = "beta") 
