...
# PRUEBA 1	RANDOM FOREST:
    ...
    - Sin balancear en la receta por orientación
        ...
        **Curva Roc Final:  0.6690901 **
        (empeoro en relacion al anterior 0.75)
...
# Sólo estos son necesarios para la consigna 3
objetos_a_no_eliminar <- c("noticias_topico_6", "noticias", "embedding")
...
# PRUEBA 3	REGRESION LOGISTICA LASSO:
    ...
    - Sin balancear en la receta por orientación 
      ...
      **Curva Roc Final 0.6206213**
      (empeora antes era de 0.77)
...
# especifico la receta
noticias_rec_embed_lasso <- train_embed_lasso |> 
  recipe(orientacion ~ .) %>%
  update_role("title_id", new_role = "ID") 
